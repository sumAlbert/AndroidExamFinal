...
public class Test4  extends BaseActivity implements View.OnClickListener,
...
//        AMapLocationListener locationListener = null;
    ...
    public void searchButton() {
        ...
        if ("".equals(keyWord)) {
            ToastUtil.show(Test4.this, "请输入搜索关键字");
            return;
        } else {
            doSearchQuery();
        }
...
//    }
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(Test4.this, infomation);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (!AMapUtil.IsEmptyOrNullString(newText)) {
            ...
            Inputtips inputTips = new Inputtips(Test4.this, inputquery);
...
//                    search(location.getText().toString());
                    ...
                    Toast.makeText(Test4.this, "地址不能为空", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
