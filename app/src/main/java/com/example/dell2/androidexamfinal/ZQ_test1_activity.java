...
/**
 * Created by wangyan on 2017/6/20.
 */

public class ZQ_test1_activity  extends BaseActivity implements View.OnClickListener,
...
//        AMapLocationListener locationListener = null;
    ...
    public void searchButton() {
        ...
        if ("".equals(keyWord)) {
            ToastUtil.show(ZQ_test1_activity.this, "请输入搜索关键字");
            return;
        } else {
            doSearchQuery();
        }
...
//    }
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        ToastUtil.show(ZQ_test1_activity.this,
                                R.string.no_result);
                    }
                }
            } else {
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(ZQ_test1_activity.this, infomation);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (!AMapUtil.IsEmptyOrNullString(newText)) {
            ...
            Inputtips inputTips = new Inputtips(ZQ_test1_activity.this, inputquery);
...
//                    search(location.getText().toString());
                    ...
                    Toast.makeText(ZQ_test1_activity.this, "地址不能为空", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
